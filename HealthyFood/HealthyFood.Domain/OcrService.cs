    ...
    public class OcrService
    {
        ...
        public static List<Eitem>  GetAllEitems()
        {
            List<Eitem> eitemsList = new List<Eitem>()
            {
                ...
                {
                    Ecode = "E330",
                    DangerLevel = "опасность очень низкая",
                    Type = "Консерванты",
                    RealName = "Лимонная кислота",
                    Description = "Добавки E330 относятся к группе пирофосфатов — солей и эфиров пирофосфорной кислоты.При чрезмерном употреблении добавки, она может вызывать расстройство желудка, а также нарушения, связанные с дисбалансом фосфора и кальция в организме."
                }
             };
